...
window.onload = function () {
    ...
    label.push(r.text(60, 27, "").attr(txt1).attr({fill: 'white'}));
    label.hide();
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[0].attr({text: data + " euro" + (data == 1 ? "" : "s")}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
